...
// const printPDF = async (pdfBytes, printerName, colorIndex, copies) => {
//   try {
...
//     printJob.addFilePDF(base64Pdf, 'print.pdf', copies);

//     // Set print options
//     if (colorIndex === 1) {
//       printJob.setPrintColor(false); // Set to grayscale
//     } else {
//       printJob.setPrintColor(true); // Set to color
//     }

//     // Send the print job
//     await JSPM.JSPrintManager.print(printJob);
//   } catch (error) {
//     console.error('Error sending print job:', error);
//     throw error;  // Re-throw the error if you want it to be handled in the calling function
//   }
// };
...
//     // Read the PDF file and print it
//     const printerName = paperSizeIndex === 1 ? printerLong : printerShort;
//     await printPDF(updatedPdfBytes, printerName, colorIndex, copies);
//     console.log('Printing started');
